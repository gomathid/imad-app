...
'article-Two':{ title:'Article Two | Gomathi',
    heading:'Article Two',
    date:'Sep 10, 2016',
    content:`<p>
This is content of my second article.
</p>`},
'article-Three':{ title:'Article Three | Gomathi',
...
app.get('/ui/phones.jpg', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'phones.jpg'));
});
